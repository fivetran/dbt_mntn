...
{% set columns = [
    ...
    {"name": "existing_site_visitor", "datatype": dbt.type_int()},
    {"name": "existing_user_reached", "datatype": dbt.type_int()},
    ...
    {"name": "new_site_visitor", "datatype": dbt.type_int()},
    {"name": "new_user_reached", "datatype": dbt.type_int()},
    {"name": "order_value", "datatype": dbt.type_float()},
    {"name": "roas", "datatype": dbt.type_float()},
    {"name": "roi", "datatype": dbt.type_float()},
    {"name": "site_visitor", "datatype": dbt.type_int()},
...
{{ fivetran_utils.add_pass_through_columns(base_columns=columns, pass_through_var=var('mntn__segment_passthrough_metrics', none)) }}
