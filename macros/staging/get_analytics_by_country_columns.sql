{% macro get_analytics_by_country_columns() %}
...
{% set columns = [
    ...
    {"name": "iso_code", "datatype": dbt.type_string()},
...
{{ fivetran_utils.add_pass_through_columns(base_columns=columns, pass_through_var=var('mntn__country_passthrough_metrics', none)) }}
