{% macro get_analytics_by_state_columns() %}
...
{% set columns = [
    ...
    {"name": "parent_code", "datatype": dbt.type_string()},
    ...
    {"name": "unique_code", "datatype": dbt.type_string()},
...
{{ fivetran_utils.add_pass_through_columns(base_columns=columns, pass_through_var=var('mntn__region_passthrough_metrics', none)) }}
