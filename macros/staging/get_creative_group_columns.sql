{% macro get_creative_group_columns() %}
...
{{ fivetran_utils.add_pass_through_columns(base_columns=columns, pass_through_var=var('mntn__ad_group_passthrough_metrics', none)) }}
